  ...
  return (
    <div style={{ padding: "15px" }}>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              (§ 147 Abs. 3 i. V. m. Abs. 1 Nr. 1, 4 und 4a AO, § 14b Abs. 1
            ...
            <li>
              ...
              Abs. 3 i. V. m. Abs. 1 Nr. 2, 3, 5 AO, § 257 Abs. 1 Nr. 2 u. 3,
              Abs. 4 HGB).
            </li>
            <li>
      ...
      <ul className="m-elements">
        ...
        <li>
          <strong>IT-Dienstleistungen: </strong>Wir verarbeiten die Daten
          unserer Kunden sowie Auftraggeber, um ihnen die Planung,
          Implementierung sowie den Support von IT-Lösungen und damit
          verbundenen Dienstleistungen zu ermöglichen. Die erforderlichen
          Angaben sind als solche im Rahmen des Auftrags-, Projekt- bzw.
          ...
          <br />
          Zu den Verarbeitungsprozessen zählen unter anderem die
          Projektverwaltung und -dokumentation, welche alle Phasen von der
          initialen Anforderungsanalyse bis zum Abschluss des Projekts umfassen.
          Dies beinhaltet das Erstellen und Verwalten von Projektzeitplänen,
          Budgets sowie Ressourcenallokationen. Die Datenverarbeitung
          unterstützt auch das Change Management, bei dem Änderungen im
          Projektablauf dokumentiert und nachverfolgt werden, um Compliance und
          ...
          Supportanfragen, Fehlerbehebungen und regelmäßige Wartungen
          einschließt.
          <br />
          <br />
          Ferner werden Reporting und die Leistungsanalyse durchgeführt, wodurch
          Leistungskennzahlen erfasst und ausgewertet werden, um die
          Effektivität der erbrachten IT-Lösungen zu bewerten und kontinuierlich
          zu optimieren. All diese Prozesse sind darauf ausgerichtet, eine hohe
      ...
      <ul className="m-elements">
        ...
        <li>
          <strong>Vercel: </strong>Leistungen auf dem Gebiet der Bereitstellung
          von informationstechnischer Infrastruktur und verbundenen
          Dienstleistungen (z. B. Speicherplatz und/oder Rechenkapazitäten)
          sowie Entwicklungsumgebung;
          <strong>Dienstanbieter:</strong> Vercel Inc., 340 S Lemon Ave #4133,
          Walnut, CA 91789, USA;
          <span className="">
            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6
            Abs. 1 S. 1 lit. f) DSGVO;{" "}
      ...
      <ul className="m-elements">
        <li>
          ...
          Identifikationsnummern, beteiligte Personen); Vertragsdaten (z. B.
          Vertragsgegenstand, Laufzeit, Kundenkategorie). Protokolldaten (z. B.
          Logfiles betreffend Logins oder den Abruf von Daten oder
          Zugriffszeiten.).
        </li>
        <li>
      ...
      <p>
        <strong>Datenschutzmaßnahmen der Teilnehmer:</strong> Bitte beachten Sie
        zu den Details der Verarbeitung Ihrer Daten durch die
      ...
      <ul className="m-elements">
        <li>
          ...
          Nutzungsdaten (z. B. Seitenaufrufe und Verweildauer, Klickpfade,
          Nutzungsintensität und -frequenz, verwendete Gerätetypen und
          Betriebssysteme, Interaktionen mit Inhalten und Funktionen); Bild-
      ...
      <ul className="m-elements">
        <li>
          <strong>Google Hangouts / Meet: </strong>Konferenz- und
          Kommunikationssoftware; <strong>Dienstanbieter:</strong> Google
        ...
        <li>
          <strong>Microsoft Teams: </strong>Audio- und Videokonferenzen, Chat,
          Dateifreigabe, Integration mit Office 365-Anwendungen,
          Echtzeit-Zusammenarbeit an Dokumenten, Kalenderfunktionen,
          Aufgabenverwaltung, Bildschirmfreigabe, optionale Aufzeichnung;
          <strong>Dienstanbieter:</strong> Microsoft Irland Operations Limited,
        ...
        <li>
          ...
          <strong>Dienstanbieter:</strong> Slack Technologies Limited, Level 1,
          Block A Nova Atria North, Sandyford Business District, Dublin 18,
          Irland;
          <span className="">
            <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6
            Abs. 1 S. 1 lit. f) DSGVO;{" "}
          ...
          ; <strong>Datenschutzerklärung:</strong>
          <a href="https://slack.com/intl/de-de/legal" target="_blank">
        ...
        <li>
          <strong>TeamViewer: </strong>Konferenz- und Kommunikationssoftware;
          ...
          . <strong>Datenschutzerklärung:</strong>
          <a
            href="https://www.teamviewer.com/de/legal/privacy-and-cookies/"
            target="_blank">
        ...
        <li>
          <strong>Whereby: </strong>Videokonferenzen, Webkonferenzen und
          Webinare;
          <strong>Dienstanbieter:</strong> Video Communication Services AS, Gate
          ...
          Standardvertragsklauseln (
          <a
            href="https://whereby.helpscoutdocs.com/article/526-data-storage-and-security#dpa"
            target="_blank">
            https://whereby.helpscoutdocs.com/article/526-data-storage-and-security#dpa
          </a>
          ).
        </li>
        <li>
          <strong>Zoom: </strong>Konferenz- und Kommunikationssoftware;
          ...
          ;<strong>Datenschutzerklärung:</strong>
          <a
            href="https://explore.zoom.us/docs/de-de/privacy-and-legal.html"
            target="_blank">
      ...
      <ul className="m-elements">
        <li>
          ...
          die nötig sind, damit der Inhalt des Widgets an den Browser des
          Nutzers ausgeliefert werden kann. Des Weiteren erhält der
          Widgets-Anbieter Informationen darüber, dass Nutzer unser
          Onlineangebot besucht haben. Diese Informationen können in einem
          Cookie gespeichert und von dem Widgets-Anbieter verwendet werden, um
          zu erkennen, welche Onlineangebote, die am dem Bewertungsverfahren
          teilnehmen, von dem Nutzer besucht worden sind. Die Informationen
          können in einem Nutzerprofil gespeichert und für Werbe- oder
        ...
        <li>
          <strong>Google Kundenrezensionen: </strong>Dienst zur Einholung
          und/oder Darstellung der Kundenzufriedenheit und Kundenmeinungen;
          ...
          ; <strong>Grundlage Drittlandtransfers:</strong> Data Privacy
          Framework (DPF); <strong>Weitere Informationen:</strong> Im Rahmen der
          Einholung von Kundenrezensionen werden eine Identifikationsnummer
          sowie Zeitpunkt für den zu bewertenden Geschäftsvorgang, bei direkt an
          Kunden versendeten Rezensionsanfragen die E-Mailadresse des Kunden
          sowie deren Angabe zum Land des Wohnsitzes als auch die
          Rezensionsangaben selbst verarbeitet; Weitere Angaben zu den Arten der
      ...
      <ul className="m-elements">
        <li>
          <strong>Instagram: </strong>Soziales Netzwerk, ermöglicht das Teilen
        ...
        <li>
          ...
          Profil der Nutzer, wie Berufsfunktion, Land, Branche, Hierarchieebene,
          Unternehmensgröße und Beschäftigungsstatus. Datenschutzinformationen
          zur Verarbeitung von Daten der Nutzer durch LinkedIn können den
          ...
          LinkedIn beachten muss und in der LinkedIn sich bereit erklärt hat die
          Betroffenenrechte zu erfüllen (d. h. Nutzer können z. B. Auskünfte
          oder Löschungsanfragen direkt an LinkedIn richten). Die Rechte der
          Nutzer (insbesondere auf Auskunft, Löschung, Widerspruch und
          Beschwerde bei zuständiger Aufsichtsbehörde), werden durch die
          ...
          und die Übermittlung an die Ireland Unlimited Company, ein Unternehmen
      ...
      <ul className="m-elements">
        <li>
          ...
          Fonts veröffentlicht. Schließlich wird die Verweis-URL protokolliert,
          sodass die Daten für die Wartung der Produktion verwendet und ein
      ...
      <ul className="glossary">
        ...
        <li>
          ...
          Verarbeitung von &quot;Profilen mit nutzerbezogenen
          Informationen&quot;, bzw. kurz &quot;Profilen&quot; umfasst jede Art
        ...
        <li>
          ...
          der Vereinbarung. Vertragsdaten können Start- und Enddaten des
          Vertrages, die Art der vereinbarten Leistungen oder Produkte,
          Preisvereinbarungen, Zahlungsbedingungen, Kündigungsrechte,
          Verlängerungsoptionen und spezielle Bedingungen oder Klauseln
          umfassen. Sie dienen als rechtliche Grundlage für die Beziehung
          zwischen den Parteien und sind entscheidend für die Klärung von
          Rechten und Pflichten, die Durchsetzung von Ansprüchen und die Lösung
          von Streitigkeiten.
        </li>
        <li>
